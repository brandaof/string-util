...
public class StringTemplate {
    ...
    private List<StringTemplateVar> vars;
    ...
    private void parse(String content) {
        ...
        vars = new ArrayList<StringTemplateVar>();
    ...
    private String createPreRegex(){
        ...
        for( int i=0;i<vars.size();i++ ){
        	StringTemplateVar p = (StringTemplateVar)vars.get(i);
    ...
    public void toWriter(Writer writter, Object ... params) throws IOException{
        ...
        for(int i=0;i<vars.size();i++ ){
            ...
            if(v instanceof StringTemplate) {
            	((StringTemplate)v).toWriter(writter, params);
            }
            else
	...
	public List<StringTemplateVar> getVars() {
		return vars;
	}
